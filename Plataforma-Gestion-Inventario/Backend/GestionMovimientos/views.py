...
from .serializers import MovimientoStockSerializer, ActualizarStockSerializer, TransferenciaSerializer
...
class TransferenciaListCreateAPIView(APIView):
    queryset = Transferencia
    serializer_class = TransferenciaSerializer

class TransferenciaDetailAPIView(APIView):
