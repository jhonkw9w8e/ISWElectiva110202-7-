...
SECRET_KEY = 'django-insecure-%+xou3q$#9e3k_w(5x^%2zd779ryv4vum=yv4y0kp6bgv*(du6'
...
ALLOWED_HOSTS = [
    'localhost', 
    '127.0.0.1', 
    'plataforma-gestion-inventario-backend-a7g6hng8ghgae0ba.canadacentral-01.azurewebsites.net'
]
